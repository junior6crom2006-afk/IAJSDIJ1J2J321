from functions.functions import capture, random_proxy
from httpx import AsyncClient
from functions.woocomerce_funcs import b3_vbv
...
async def vbv(cc, month, year, cvv):
    for _ in range(2):  
        try:
            ...
            print(f"Error on attempt {_ + 1}: {e}")
    return "Failed after 3 attempts ❌", None
