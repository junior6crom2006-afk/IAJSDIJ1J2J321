...
from functions.functions import GetCC, Symbol, get_bin_info, AntiSpam, ProxyRandom, proxy_x, get_text_from_pyrogram
...
@Client.on_message(filters.command(['al'], PREFIXES))
async def gate_te(client, message):
    ...
    gate_info = GateManager.get_gate_info("/al")
    
    # Verificar estado del gate con la información más reciente
    if gate_info["estado"] == "OFF":
        return await message.reply_text(f"""♯𝗭𝘆𝗿𝗲𝘅 𝗖𝗵𝗸 | Moneris (/al)
━━━━━━━━━━━━━━━━━━━━
<a href="https://t.me/zyrexnews">ゕ</a>﹒Status: <b>OFFLINE</b>
<a href="https://t.me/zyrexnews">ゕ</a>﹒Reason: <b>{gate_info['razon'] or 'N/A'}</b>
<a href="https://t.me/zyrexnews">ゕ</a>﹒Last Revision: <b>{gate_info['ultima_revision']}</b>
━━━━━━━━━━━━━━━━━━━━
࿔ Bot Version: 1.0
""")
    ...
    card_details = await GetCC(text)

    if not card_details:
        return await message.reply(f"♯𝗭𝘆𝗿𝗲𝘅 𝗖𝗵𝗸 | Error\n━━━━━━━━━━━━━━━━━━━━\n<a href=\"https://t.me/zyrexnews\">ゕ</a>﹒Formato: <code>/al cc|mm|yy|cvv</code>\n━━━━━━━━━━━━━━━━━━━━\n࿔ Bot Version: 1.0")
    ...
    if (
        message.from_user.id not in [7882956639]
        and (
            resp.get("banned", False)
            or "prepaid" in level.lower()
            or "prepaid" in type_v.lower()
        )
    ):  
        return await message.reply(
            f"♯𝗭𝘆𝗿𝗲𝘅 𝗖𝗵𝗸 | Error\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"<a href=\"https://t.me/zyrexnews\">ゕ</a>﹒Bin <code>{bin_data.get('number', 'Unknown')}</code> Banned ⚠️\n"
            f"━━━━━━━━━━━━━━━━━━━━\n"
            f"࿔ Bot Version: 1.0"
        )
...
࿔ Bot Version: 1.0
    ...
    while retries < max_retries:
        try:
            ...
            status, response = await moneris(cc, mes, ano, cvv, await ProxyRandom())
...
࿔ Bot Version: 1.0
        ...
        if retries >= max_retries:
            status = "Declined ❌"
            response = "Max retries exceeded: <code>{response}</code>"
